...
function entranceClass(anim: string, delayMs = 0) {
  ...
  switch (anim) {
    case "fade":
      return { className: "ovd-fade-in", style: delayStyle };
    case "slide":
      return { className: "ovd-slide-up", style: delayStyle };
    case "zoom":
      return { className: "ovd-zoom-in", style: delayStyle };
    case "bounce":
      return { className: "ovd-bounce-in", style: delayStyle };
    default:
...
export function getCustomPadding(content: Record<string, any>) {
  ...
  const pt = content.padding_top && map[content.padding_top as string];
  const pb = content.padding_bottom && map[content.padding_bottom as string];
  return {
    ...(pt ? { paddingTop: pt } : {}),
    ...(pb ? { paddingBottom: pb } : {}),
  };
          ...
          case "product-grid":
            return renderProductGrid ? (
              <div
                ...
                style={
                  e.style ? { animationDelay: `${idx * 120}ms` } : undefined
                }
              >
                {renderProductGrid()}
              </div>
...
function FeaturedProducts({
  ...
  return (
    <div
      ...
      style={{ ...getCustomPadding(content), marginBottom: spacing.section }}
    >
      <h3
...
function Testimonials({
  ...
  const quotes: { name: string; text: string; rating: number }[] =
    content.quotes || [];
            ...
            >
              <div className="flex items-center gap-0.5 mb-3">
                {[1, 2, 3, 4, 5].map((star) => (
                  <StarSolid
                    key={star}
                    className={`h-4 w-4 ${star <= (q.rating || 5) ? "text-amber-400" : "text-slate-200"}`}
                  />
                ))}
              </div>
              <p
              ...
              <div
                ...
                style={{ borderColor: `${theme.border_color || "#e2e8f0"}80` }}
              >
                <div
                ...
                <p
                  ...
                  style={{ color: theme.heading_color || theme.text_color }}
                >
                  {q.name}
                </p>
              </div>
  ...
  truck: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.07-.504 1.004-1.125a57.006 57.006 0 0 0-2.33-10.5A2.625 2.625 0 0 0 16.5 4.5h-1.875a.375.375 0 0 0-.375.375V10.5m-3.375 8.25H7.5m9-13.5V5.625m0 0H2.25V15"
      />
    </svg>
  ),
  return: (
  ...
  diamond: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="m3.75 7.5 8.25 11.25L20.25 7.5m-16.5 0L12 2.25l8.25 5.25m-16.5 0h16.5"
      />
    </svg>
  ),
  rocket: (
          ...
          return (
            <div
              ...
              style={{
                ...
                backgroundColor: theme.surface_color || "#ffffff",
                borderRadius:
                  getBorderRadiusClass(theme.border_radius as any) ===
                  "rounded-none"
                    ? "0"
                    : "1rem",
              }}
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <input
            ...
            style={
              {
                borderRadius: theme.button_radius === "sharp" ? "0" : "0.75rem",
                "--tw-ring-color": theme.primary_color,
              } as any
            }
          />
...
function VideoPromo({
  ...
  const videoId = content.video_url?.match(
    /(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([^&]{11})/,
  )?.[1];
  const embedUrl = videoId
    ? `https://www.youtube.com/embed/${videoId}?autoplay=${playing ? 1 : 0}&mute=1`
    : content.video_url;
...
function RichText({
  ...
  return (
    <div
      className={`${alignClass} ${entrance.className} max-w-2xl px-4`}
      style={{ ...getCustomPadding(content), marginBottom: spacing.section }}
    >
      {content.title && (
        <h3
      ...
      <p
        className={`${sizeClass} leading-relaxed opacity-80`}
        style={{ color: theme.text_color }}
      >
        {content.text}
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-4 text-white">
                ...
                <span className="text-[10px] font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 uppercase tracking-widest">
                  Shop Now →
                </span>
              </div>
            </a>
...
function SplitFeature({
  ...
  return (
    <div
      className={`grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center ${entrance.className}`}
      style={{ ...getCustomPadding(content), marginBottom: spacing.section }}
    >
      {/* Target Image Container */}
      <div
        className={`relative aspect-square md:aspect-[4/5] overflow-hidden ${radiusClass} ${layoutReversed ? "md:order-2" : "md:order-1"}`}
      >
        {content.image_url ? (
          /* eslint-disable-next-line @next/next/no-img-element */
          <img
      ...
      <div
        className={`flex flex-col justify-center px-4 md:px-0 ${layoutReversed ? "md:order-1" : "md:order-2"}`}
      >
        {content.eyebrow && (
          <span
        ...
        <p
          className="text-base md:text-lg opacity-80 leading-relaxed mb-8"
          style={{ color: theme.text_color }}
        >
          {content.subtitle ||
            "Use this split layout to dynamically showcase a featured product, a new collection, or an important aspect of your brand story."}
        </p>
        ...
        {content.cta_text && (
          <div>
            <a
              ...
              className={`inline-flex items-center justify-center gap-2 px-8 py-4 text-sm font-bold shadow-lg ${btn.className} focus-visible:outline-none focus-visible:ring-2`}
              style={
                {
                  ...btn.style,
                  ["--tw-ring-color" as any]: theme.primary_color,
