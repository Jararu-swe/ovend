    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center gap-1.5 p-3 rounded-xl bg-slate-50 border border-slate-100">
        {[theme.primary_color, theme.secondary_color, theme.accent_color, theme.background_color, theme.surface_color, theme.text_color, theme.heading_color, theme.border_color].map((c, i) => (
          <div key={i} className="h-6 flex-1 rounded-md ring-1 ring-black/5" style={{ backgroundColor: c }} />
        ))}
      </div>

      {/* Color inputs */}
      <div className="space-y-2">
        <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 px-1">Primary Colors</h3>
      ...
      <div className="space-y-2">
        <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 px-1">Backgrounds</h3>
      ...
      <div className="space-y-2">
        <h3 className="text-[11px] font-bold uppercase tracking-wider text-slate-400 px-1">Text</h3>
