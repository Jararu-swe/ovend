...
import DesignTokensPanel from '@/app/ui/customize/panels/design-tokens-panel';

type PanelId = 'home' | 'themes' | 'sections' | 'section-detail' | 'colors' | 'typography' | 'layout' | 'buttons' | 'brand' | 'iconography' | 'advanced' | 'design-tokens';
...
export default function EditorSidebar({
  ...
  const homeItems: { id: PanelId; icon: React.ReactNode; label: string; description: string }[] = [
    ...
    },
    {
      id: 'design-tokens',
      label: 'Design Tokens',
      description: 'Advanced design system controls',
          ...
          <div className="flex flex-col h-full bg-white rounded-2xl border border-slate-200/60 shadow-[0_8px_30px_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden">
              <div className="animate-in fade-in duration-200">
                ...
                {/* Design Tokens panel */}
                {currentPanel.id === 'design-tokens' && (
                  <DesignTokensPanel theme={localTheme} onChange={onThemeChange} subscriptionTier={subscriptionTier} />
                )}
              </div>
            </div>
          </div>
