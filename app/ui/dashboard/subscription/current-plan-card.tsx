  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        {canCancel && onCancelSubscription && (
          <button
            ...
            className="hidden sm:block rounded-lg border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
      ...
      {canCancel && onCancelSubscription && (
        <button
          onClick={onCancelSubscription}
          className="mt-6 w-full sm:hidden rounded-lg border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          aria-label="Cancel subscription"
        >
          Cancel Subscription
        </button>
