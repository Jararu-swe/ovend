...
export const SECTION_TYPES = [
  ...
  { id: 'newsletter',        label: 'Newsletter',        icon: '✉️', description: 'Email signup for updates', removable: true },
  { id: 'video-promo',       label: 'Video Promo',       icon: '🎥', description: 'Featured video or background', removable: true },
  { id: 'logo-cloud',        label: 'Logo Cloud',        icon: '🏢', description: 'Brand partners or trusted by logos', removable: true },
  { id: 'rich-text',         label: 'Rich Text',         icon: '📝', description: 'Flexible text block with styling', removable: true },
  { id: 'split-feature',     label: 'Split Feature',     icon: '◨', description: 'Side-by-side image and text block', removable: true },
  { id: 'category-grid',     label: 'Category Grid',     icon: '📂', description: 'Quick links to categories', removable: true },
] as const;
...
const DEFAULT_SECTION_CONTENT: TemplateSectionContent = {
  ...
  'logo-cloud': {
    title: 'Trusted By',
    logos: [
      { url: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', name: 'Amazon' },
      { url: 'https://upload.wikimedia.org/wikipedia/commons/b/b9/Slack_Technologies_Logo.svg', name: 'Slack' },
    ],
  },
  'rich-text': {
  ...
  'category-grid': {
    ...
    categories: [
      { id: '1', name: 'New Arrivals', image_url: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=300&h=300&fit=crop', link: '#item-list' },
      { id: '2', name: 'Best Sellers', image_url: 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=300&h=300&fit=crop', link: '#item-list' },
    ],
  },
};
...
export const TEMPLATES: Template[] = [
  ...
  // ── 9. Vogue Minimal (Fashion) ─────────────────────────────
  {
    id: 'vogue-minimal',
    name: 'Vogue Minimal',
    description: 'High-end editorial fashion look with large imagery and refined typography.',
    emoji: '👠',
    category: 'fashion',
  ...
  // ── 10. Artisan Dark (Artisan) ─────────────────────────────
  {
    id: 'artisan-dark',
    name: 'Artisan Dark',
    description: 'Deep earthy tones with subtle glassmorphism for a sophisticated craft look.',
    emoji: '🏺',
    category: 'artisan',
  ...
  // ── 11. Street Vibe (Fashion) ──────────────────────────────
  {
    id: 'street-vibe',
    name: 'Street Vibe',
    description: 'Bold, high-contrast streetwear aesthetic with loud typography.',
    emoji: '🛹',
    category: 'fashion',
  ...
  // ── 12. Vintage Retro (Fashion) ────────────────────────────
  {
    id: 'vintage-retro',
    name: 'Vintage Retro',
    description: 'Warm cream tones and classic serifs for thrift and vintage shops.',
    emoji: '📻',
    category: 'fashion',
  ...
  // ── 13. Gourmet Bistro (Food) ──────────────────────────────
  {
    id: 'gourmet-bistro',
    name: 'Gourmet Bistro',
    description: 'Elegant charcoal and gold aesthetic for fine dining and bakeries.',
    emoji: '🍴',
    category: 'food',
  ...
  // ── 14. Coffee Roasters (Food) ─────────────────────────────
  {
    ...
    description: 'Warm browns and craft paper tones for cafes and coffee shops.',
    emoji: '☕',
    category: 'food',
  ...
  // ── 18. Serene Spa (Beauty) ────────────────────────────────
  {
    id: 'serene-spa',
    name: 'Serene Spa',
    description: 'Soft sage greens and airy whitespace for wellness and relaxation.',
    emoji: '🌿',
    category: 'beauty',
  ...
  // ── 19. Makeup Studio (Beauty) ─────────────────────────────
  {
    id: 'makeup-studio',
    name: 'Makeup Studio',
    description: 'Hot pinks and gloss effects for professional makeup and cosmetics.',
    emoji: '💄',
    category: 'beauty',
    ...
    sectionContent: {
      ...
      'hero-banner': {
        ...
        subtitle: 'Unleash your inner artist with professional grade cosmetics.',
  ...
  // ── 20. Organic Roots (Beauty) ─────────────────────────────
  {
    id: 'organic-roots',
    name: 'Organic Roots',
    description: 'Earthy greens and recycling-inspired textures for eco-brands.',
    emoji: '🎋',
    category: 'beauty',
  ...
  // ── 22. Leather & Grain (Artisan) ──────────────────────────
  {
    id: 'leather-grain',
    name: 'Leather & Grain',
    description: 'Rugged tan and dark wood tones for leathercraft and woodworkers.',
    emoji: '👞',
    category: 'artisan',
    ...
    sectionContent: {
      ...
      'hero-banner': {
        ...
        cta_text: 'Shop Gear',
        image_url: 'https://images.unsplash.com/photo-1481277542470-605612bd2d61?w=1200&h=800&fit=crop',
      },
    },
  },
  ...
  // ── 23. Monochrome Pro (Premium) ───────────────────────────
  {
    ...
    sectionContent: {
      ...
      'hero-banner': {
        ...
        cta_text: 'PURCHASE',
        image_url: 'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=1200&h=800&fit=crop',
      },
    },
  },
  ...
  // ── 24. Gold Reserve (Premium) ─────────────────────────────
  {
    ...
    sectionContent: {
      ...
      'hero-banner': {
        ...
        image_url: 'https://images.unsplash.com/photo-1618022325802-7e5e732d97a1?w=1200&h=800&fit=crop',
      },
    },
  },
];
